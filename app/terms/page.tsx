export default function TermsOfService() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 text-[var(--text-primary)]">
      <h1 className="text-4xl font-bold mb-4 font-display">Terms and Conditions</h1>
      <p className="text-sm text-[var(--text-tertiary)] mb-8">Last updated: April 01, 2026</p>

      <div className="prose prose-blue max-w-none space-y-6">
        <p>Please read these terms and conditions carefully before using Our Service.</p>

        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Interpretation and Definitions</h2>

        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Interpretation</h3>
        <p>The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>

        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Definitions</h3>
        ...
        <ul className="list-disc pl-6 space-y-3">
          ...
          <li><strong>Website</strong> refers to SarkariSaathi, accessible from <a href="https://sarkari-saathi-v1.vercel.app/" rel="external nofollow noopener" target="_blank" className="text-[var(--primary)] hover:underline font-semibold">https://sarkari-saathi-v1.vercel.app/</a></li>
          <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>

        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Acknowledgment</h2>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Links to Other Websites</h2>
        ...
        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Links from a Third-Party Social Media Service</h3>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Termination</h2>
        <p>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
        <p>Upon termination, Your right to use the Service will cease immediately.</p>

        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Limitation of Liability</h2>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Governing Law</h2>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Disputes Resolution</h2>
        <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>

        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">For European Union (EU) Users</h2>
        <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.</p>

        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">United States Legal Compliance</h2>
        <p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>

        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Severability and Waiver</h2>

        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Severability</h3>
        <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>

        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Waiver</h3>
        <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party&apos;s ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>

        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Translation Interpretation</h2>
        <p>These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.</p>

        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Changes to These Terms and Conditions</h2>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Contact Us</h2>
        <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
        <ul className="list-disc pl-6 space-y-3">
          <li>By email: <a href="mailto:nexusai.build@gmail.com" className="text-[var(--primary)] hover:underline font-semibold">nexusai.build@gmail.com</a></li>
        </ul>
      </div>
    </div>
  );
