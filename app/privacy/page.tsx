  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 text-[var(--text-primary)]">
      ...
      <div className="prose prose-blue max-w-none space-y-6">
        ...
        <p>We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noopener noreferrer" className="text-[var(--primary)] hover:underline font-semibold">Privacy Policy Generator</a>.</p>
        ...
        <ul className="list-disc pl-6 space-y-3">
          ...
          <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to NexusAI, n/a.</li>
          <li><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</li>
          <li><strong>Country</strong> refers to: Rajasthan, India</li>
          <li><strong>Device</strong> means any device that can access the Service such as a computer, a cell phone or a digital tablet.</li>
          <li><strong>Personal Data</strong> (or &quot;Personal Information&quot;) is any information that relates to an identified or identifiable individual.<br /><br />We use &quot;Personal Data&quot; and &quot;Personal Information&quot; interchangeably unless a law uses a specific term.</li>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Collecting and Using Your Personal Data</h2>
        
        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Types of Data Collected</h3>
        <h4 className="text-lg font-bold mt-6 mb-2 font-display">Personal Data</h4>
        <p>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
        <ul className="list-disc pl-6 space-y-3">
          <li>Email address</li>
        </ul>
        
        <h4 className="text-lg font-bold mt-6 mb-2 font-display">Usage Data</h4>
        ...
        <h4 className="text-lg font-bold mt-6 mb-2 font-display">Tracking Technologies and Cookies</h4>
        ...
        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Use of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Retention of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Transfer of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Delete Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Disclosure of Your Personal Data</h3>
        <h4 className="text-lg font-bold mt-6 mb-2 font-display">Business Transactions</h4>
        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
        <h4 className="text-lg font-bold mt-6 mb-2 font-display">Law enforcement</h4>
        <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        <h4 className="text-lg font-bold mt-6 mb-2 font-display">Other legal requirements</h4>
        ...
        <h3 className="text-xl font-bold mt-8 mb-3 font-display">Security of Your Personal Data</h3>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Children&apos;s Privacy</h2>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4 font-display">Changes to this Privacy Policy</h2>
